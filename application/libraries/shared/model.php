	...
	class Model extends \Framework\Model implements JsonSerializable {
		...
		public function removeCache() {
			foreach (static::CACHE_KEYS as $arr) {
				...
				Db::removeModelCache(get_class($this), $query, $fields);
			}
		}
		...
		/**
		 * This function insert the logs data for the model
		 * @param  string $event
		 */
		public function insertSuperadminLog($event) {
		}
		...
		public static function displayImg($name = '', $folder = "images") {
			return \Shared\Utils::media($name, 'display');
		}
		...
		public function save() {
			...
			$appConfig = Utils::getConfig('app')->app;
			if ($appConfig->type == 'superadmin') {
				$this->insertSuperadminLog($timelineEvent);
			}
		}
