...
namespace Framework {
    ...
    class Template extends Base {
         ...
         */
        public function parse($template, $templateFP) {
            ...
            $temp = tmpfile();
            fwrite($temp, '<?php return function ($_data) {' . $this->code . '};');
            $filePath = stream_get_meta_data($temp)['uri'];
            $this->_function = include $filePath;
            fclose($temp);
        ...
        public static function printMessage($msg = null) {
            if (!isset($msg)) return '';
            if (is_array($msg)) {
                switch ($msg["type"]) {
                    case 'success':
                        return '<div class="alert" style="background-color: #20bfae !important; color: #fff; box-shadow: 10px 10px 10px #aaaaaa8a; padding: 8px 15px; display: flex; justify-content: space-between;"><div style="display: flex; align-items: center;"><i class="fa fa-check-circle" style="font-size: 36px; margin-right: 12px;"></i>'.$msg["text"].'</div><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button></div>';
                    case 'warning':
                        return '<div class="alert" style="background-color: #fa8c16 !important; color: #fff; box-shadow: 10px 10px 10px #aaaaaa8a; padding: 8px 15px; display: flex; justify-content: space-between;"><div style="display: flex; align-items: center;"><i class="fa fa-exclamation-circle" style="font-size: 36px; margin-right: 12px;"></i>'.$msg["text"].'</div><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button></div>';
                    case 'error':
                        return '<div class="alert" style="background-color: #f44336 !important; color: #fff; box-shadow: 10px 10px 10px #aaaaaa8a; padding: 8px 15px; display: flex; justify-content: space-between;"><div style="display: flex; align-items: center;"><i class="fa fa-exclamation-circle" style="font-size: 36px; margin-right: 12px;"></i>'.$msg["text"].'</div><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button></div>';
                    default:
                ...
                return '<div class="alert" style="background-color: #20bfae !important; color: #fff; box-shadow: 10px 10px 10px #aaaaaa8a; padding: 8px 15px; display: flex; justify-content: space-between;"><div style="display: flex; align-items: center;"><i class="fa fa-check-circle" style="font-size: 36px; margin-right: 12px;"></i>'.$msg.'</div><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button></div>';
            }
        }
